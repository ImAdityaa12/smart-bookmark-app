    ...
    <div className="space-y-3">
      {bookmarks.map((bookmark, index) => {
        ...
        return (
          <div
            key={bookmark.id}
            className={`group glass-strong rounded-2xl border border-white/40 shadow-md p-5 hover:shadow-xl hover:shadow-indigo-100/50 hover:-translate-y-0.5 transition-all duration-300 animate-fade-in opacity-0 ${staggerClass} ${
              isOptimistic ? 'bookmark-optimistic' : ''
            }`}
          >
