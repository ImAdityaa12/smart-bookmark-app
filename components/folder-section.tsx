...
function FolderChip({
  ...
  return (
    <>
      <div
        ref={setNodeRef}
        className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-[13px] font-medium cursor-pointer transition-all duration-150 select-none flex-shrink-0 ${
          isSelected
      ...
      >
        ...
        {menuOpen && (
          <div
            ref={menuRef}
            className="absolute top-full left-0 mt-1.5 z-50 bg-white border border-[#E5E7EB] rounded-xl shadow-lg py-1 min-w-[130px]"
